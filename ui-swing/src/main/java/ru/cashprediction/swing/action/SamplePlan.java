 ...
 *
 * <p>Состав плана зафиксирован общей спецификацией трёх клиентов: один и тот же пример даёт одинаковую таблицу
 * и одинаковый файл .md в JavaFX, Swing и Web. Категории и заметки пустые — спецификация их не задаёт.
 * Класс без состояния, потокобезопасен.</p>
 */
public final class SamplePlan {

    /** Имя плана-примера. */
    public static final String NAME = "Пример";
     ...
     * @return новый план (открывается как несохранённый)
     */
    public static Plan samplePlan(LocalDate today) {
        ...
        List<RecurringRule> rules = List.of(
                ...
                rule("r4", "Продукты", Kind.EXPENSE, Money.ofMajor(4_000), new Recurrence.Weekly(DayOfWeek.SATURDAY, 1),
                        WeekendPolicy.NONE),
                // 31 означает «последний день месяца»: в феврале это 28 или 29 число.
